...
**********************************************
*INCLUDE, INPUT=/home/ms20s284/FABCORT/ResolutionEffect/{Mesh}
*INCLUDE, INPUT=/home/ms20s284/FABCORT/ResolutionEffect/Material_Isotropic.inp
**
** Interactions (*Equation and *Nset)
**********************************************
*INCLUDE, INPUT=/home/ms20s284/FABCORT/ResolutionEffect/{BCs}
**
** Steps Definitions
***************** Tensile 1 ******************
*STEP
...
def WriteBash(Sample, Size):
    ...
    Text = f"""abaqus interactive job={Job} inp="/home/ms20s284/FABCORT/ResolutionEffect/{Main}" cpus=24
abaqus python "/home/ms20s284/FABCORT/Scripts/abqSeReader.py" in="/home/ms20s284/FABCORT/Simulations/{ODBFile}"  out="/home/ms20s284/FABCORT/ResolutionEffect/{OutFile}"  size="{Size[0]};{Size[1]};{Size[2]}" spec="Stress" 
rm * 
"""
