...
def Main():
    ...
    # Build linear system for only 1 l
    Step = 12
    ...
    FName = Path(__file__).parents[1] / '_Results/Cortical/ProposedModel.png'
    R2adj, NE = PlotFit(Transverse, Lambda0, Lambda0p, Mu0, kl, km, l, Rho, Fabric, FName=str(FName))
